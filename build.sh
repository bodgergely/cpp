...
g++ -std=c++17 -g -O0 -march=native -Wall -Wextra -Werror -Wpedantic -Wno-sign-compare -Wno-unused-parameter -Wno-unused-variable -o $DIR/cpp/main.exe $DIR/cpp/main.cpp
